...
If you want to install \ClutTeX\ manually, fetch an archive from GitHub\footnote{\url{https://github.com/atticus-sullivan/cluttex_teal}}, extract it, and copy \texttt{bin/cluttex\_teal} or \texttt{bin/cluttex\_teal.bat} to somewhere in your \texttt{PATH}.
